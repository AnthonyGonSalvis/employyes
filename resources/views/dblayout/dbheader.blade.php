...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
     <title>Synergy-Soft-India-Dashboard</title>
    ...
    <script src="https://kit.fontawesome.com/302e0adc4b.js" crossorigin="anonymous"></script>
...
<body class="app">   	
        ...
        <div id="app-sidepanel" class="app-sidepanel"> 
	        ...
	        <div class="sidepanel-inner d-flex flex-column">
		        ...
		        <div class="app-branding">
		            <a class="app-logo" href="{{url('/admin')}}"><img class="logo-icon me-2" src="{{url('index/assets/img/logo3.png')}}" alt="logo"><span class="logo-text">Synergy Soft</span></a>
		            <!-- <link href="{{url('index/assets/img/logo3.png')}}" rel="icon">
                    <link href="{{url('index/assets/img/apple-touch-icon.png')}}" rel="apple-touch-icon"> -->
				    ...
				    <ul class="app-menu list-unstyled accordion " id="menu-accordion">
					    ...
					    <li class="nav-item">
					        ...
					        <a class="nav-link" href="{{route('slider.index')}}">
						        ...
						        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi fa-solid fa-rug" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
					    ...
					    <li class="nav-item">
					        ...
					        <a class="nav-link" href="{{route('employees.index')}}">
						        <span class="nav-icon">
						        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi fa-solid fa-people-group" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
					    ...
					    <li class="nav-item">
					        ...
					        <a class="nav-link" href="{{route('values.index')}}">
						        ...
						        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-list" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
		                         ...
		                         <span class="nav-link-text">Our Values</span>
					        </a><!--//nav-link-->
					    </li><!--//nav-item-->
					    ...
					    <li class="nav-item has-submenu">
					        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
					        <a class="nav-link submenu-toggle" href="{{route('portfolios.index')}}">
						        <span class="nav-icon">
						        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
					     ...
					     <li class="nav-item">
					        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
					        <a class="nav-link" href="{{route('testinomial.index')}}">
						        <span class="nav-icon">
						        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi	fa fa-address-card" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                  
                                  
                                </svg>
						         </span>
		                         <span class="nav-link-text">Testinomial</span>
					        </a><!--//nav-link-->
					    </li><!--//nav-item-->
					    <li class="nav-item has-submenu">
					        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
					        <a class="nav-link submenu-toggle" href="{{route('servicesemp.index')}}">
						        <span class="nav-icon">
						        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
					    ...
					    <li class="nav-item has-submenu">
					        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
					        <a class="nav-link submenu-toggle" href="{{route('faq.index')}}" >
						        <span class="nav-icon">
						        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
					        ...
					        <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
						        <ul class="submenu-list list-unstyled">
							        <li class="submenu-item"><a class="submenu-link" href="notifications.html">Blog-1</a></li>
							        <li class="submenu-item"><a class="submenu-link" href="account.html">Account</a></li>
							        <li class="submenu-item"><a class="submenu-link" href="settings.html">Settings</a></li>
						        </ul>
					        </div>	
					    ...
					    <li class="nav-item">
					        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
					        <a class="nav-link" href="{{route('foots.index')}}">
						        <span class="nav-icon">
	...
	<div class="container text-center py-3">
        ...
        <small>Synergy Soft India</small>
