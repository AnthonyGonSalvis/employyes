        ...
        <div class="row">
          ...
          <div class="col-lg-8 entries">
            ...
            <article class="entry entry-single">
              ...
              <div class="entry-img">
                <img src="{{url('index/assets/img/blog/blog-1.jpg')}}" alt="" class="img-fluid">
              </div>
              ...
              <div class="entry-content">
                ...
                <img src="{{url('index/assets/img/blog/blog-inside-post.jpg')}}" class="img-fluid" alt="">
            ...
            <div class="blog-author d-flex align-items-center">
              <img src="{{url('index/assets/img/blog/blog-author.jpg')}}" class="rounded-circle float-left" alt="">
              <div>
                <h4>Jane Smith</h4>
            ...
            <div class="blog-comments">
              ...
              <div id="comment-1" class="comment">
                <div class="d-flex">
                  <div class="comment-img"><img src="{{url('index/assets/img/blog/comments-1.jpg')}}" alt=""></div>
                  <div>
              ...
              <div id="comment-2" class="comment">
                <div class="d-flex">
                  <div class="comment-img"><img src="{{url('index/assets/img/blog/comments-2.jpg')}}" alt=""></div>
                  <div>
                ...
                <div id="comment-reply-1" class="comment comment-reply">
                  <div class="d-flex">
                    <div class="comment-img"><img src="{{url('index/assets/img/blog/comments-3.jpg')}}" alt=""></div>
                    <div>
                  ...
                  <div id="comment-reply-2" class="comment comment-reply">
                    <div class="d-flex">
                      <div class="comment-img"><img src="{{url('index/assets/img/blog/comments-4.jpg')}}" alt=""></div>
                      <div>
              ...
              <div id="comment-3" class="comment">
                <div class="d-flex">
                  <div class="comment-img"><img src="{{url('index/assets/img/blog/comments-5.jpg')}}" alt=""></div>
                  <div>
              ...
              <div id="comment-4" class="comment">
                <div class="d-flex">
                  <div class="comment-img"><img src="{{url('index/assets/img/blog/comments-6.jpg')}}" alt=""></div>
                  <div>
            ...
            <div class="sidebar">
              ...
              <div class="sidebar-item recent-posts">
                <div class="post-item clearfix">
                  <img src="{{url('index/assets/img/blog/blog-recent-1.jpg')}}" alt="">
                  <h4><a href="blog-single.html">Nihil blanditiis at in nihil autem</a></h4>
                  <time datetime="2020-01-01">Jan 1, 2020</time>
                </div>

                <div class="post-item clearfix">
                  <img src="{{url('index/assets/img/blog/blog-recent-2.jpg')}}" alt="">
                  <h4><a href="blog-single.html">Quidem autem et impedit</a></h4>
                  <time datetime="2020-01-01">Jan 1, 2020</time>
                </div>

                <div class="post-item clearfix">
                  <img src="{{url('index/assets/img/blog/blog-recent-3.jpg')}}" alt="">
                  <h4><a href="blog-single.html">Id quia et et ut maxime similique occaecati ut</a></h4>
                  <time datetime="2020-01-01">Jan 1, 2020</time>
                </div>

                <div class="post-item clearfix">
                  <img src="{{url('index/assets/img/blog/blog-recent-4.jpg')}}" alt="">
                  <h4><a href="blog-single.html">Laborum corporis quo dara net para</a></h4>
                  <time datetime="2020-01-01">Jan 1, 2020</time>
                </div>

                <div class="post-item clearfix">
                  <img src="{{url('index/assets/img/blog/blog-recent-5.jpg')}}" alt="">
