              ...
              <div class="row">
                <div class="card">
                   <div class="card-body d-flex">
                      <div class="col-md-11">
                      <h3><a href="{{url('/admin')}}" style="color: #E43B3B;">Home</a>/Slider</h3>
                      </div>
                      <div class="col-md-1">
                      <a href="{{route('slider.create')}}" class="btn text-white" style="background-color: #E43B3B;">Add</a></li>
                      </div>
                   </div>
                </div>
              </div>
                        ...
                        <td><img src="{{asset('sliderimages/'.$value->images)}}" style="height: 100px; width: 100px; border-radius: 50%;"></td>
                          <td>
                            ...
                            <!-- Button to Open the Modal -->
                             <button type="button" class="btn btn-outline-danger btn-2x" data-bs-toggle="modal" data-bs-target="#myModal">
