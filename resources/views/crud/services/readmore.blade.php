...
<div class="container" style="margin-top: 8em;">
  <div class="row mt-5 mb-4">
   <!--  <div class="col-sm-10">
    ...
    <div class="col-sm-2">
      <a href="{{url('/ ')}}" class="btn text-white rounded-circle" style="background-color: #012970;">Back</a>
    </div> -->

    <div class="col-sm-12 mt-2"  style="background-color: #f6f9ff;">
      @foreach ($services->take(6) as $key => $value)
        <h1 class="display-1" style="color: #012970;">Our Services</h1>
        <hr>
          <!-- <i class="{{$value->icon}}"></i>
          <h3>{{$value->heading}}</h3> -->
        <p class="text-truncate">{!! $value->description !!}</p>
      @endforeach
    </div>
  </div>
</div>
