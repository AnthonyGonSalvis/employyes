              ...
              <div class="row">
                <div class="card">
                   <div class="card-body d-flex">
                      <div class="col-md-11">
                      <h3><a href="{{url('/admin')}}" style="color: #E43B3B;">Home</a>/Clients</h3>
                      </div>
                      <div class="col-md-1">
                      <a href="{{route('clients.create')}}" class="btn text-white" style="background-color: #E43B3B;">Add</a></li>
                      </div>
                   </div>
                </div>
              </div>
                    ...
                    <tbody>
                      <tr class="text-center">
                        ...
                        <td>
                            ...
                            <a class="btn btn-outline-primary" href="{{route('clients.edit',$value->id)}}"><i class="fa-sharp fa-solid fa-pen-clip" aria-hidden="true"></i></a>      
                            </form>
                        </td>
                       </tr>
                     </tbody>
